...
{
    return 2000000;  // Make it larger for defend
}

void PlayTest::setTactics(int index)
{
...
void PlayTest::pressing(int ballOwner)
{
...
void PlayTest::setPlayer2Keep(int ourR, int oppR)
{
...
QList<AgentRegion> PlayTest::freeRegions()
{
...
void PlayTest::coach()
{
    ...
    pressing(-1/*ballOwner*/);
}

void PlayTest::setGameOnPos(int ourR, Vector2D loc)
{
...
bool PlayTest::roleIsValid(AgentRole role)
{
...
bool PlayTest::isDefender(int index)
{
    bool out = false;
    switch (wm->ourRobot[index].Role)
    {
